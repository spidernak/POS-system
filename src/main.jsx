    ...
    <EmployeeProvider>
      <Router>
        <Routes>
          ...
          <Route element={<ProtectedRoute allowedRoles={['admin']} />}><Route path="/admin" element={<AdminSideButton><Dashboard /></AdminSideButton>} />
          <Route path="/admin/addemy" element={<AdminSideButton><AddEmployee /></AdminSideButton>} />
          <Route path="/admin/employee" element={<AdminSideButton><ListEmployee/></AdminSideButton>} />
          <Route path="/admin/addproduct" element={<AdminSideButton><Addproduct /></AdminSideButton>} />
          <Route path="/admin/product" element={<AdminSideButton><Adminproduct/></AdminSideButton>} />
          <Route path='/admin/addtype' element={<AdminSideButton><Addtype/></AdminSideButton>}/>
          <Route path='/admin/customer' element={<AdminSideButton><ListCustomer/></AdminSideButton>}/>
          <Route path='/admin/history' element={<AdminSideButton><AdminHistory/></AdminSideButton>}/>
      </Route>
