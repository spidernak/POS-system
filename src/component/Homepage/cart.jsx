...
const Cart = ({ cartItems, setCartItems, updateProductQuantities }) => {
  ...
  return (
    <div className="fixed top-0 right-0 h-full bg-white shadow-lg flex flex-col z-50">
      <Profile />
      <div className="w-[380px] h-full scroll mt-20 flex flex-col justify-between items-center">
        <div className="w-[360px] flex flex-col justify-center items-center">
          <div className="flex flex-col w-[360px] fixed top-[100px]">
            <h1 className="bg-customRed w-full flex justify-center items-center text-white h-[46px] text-[24px]">
          ...
          <div>
            {isCheckout ? (
              ...
              <OrderConfirmation orderDetails={orderDetails} handleBackToOrder={handleBackToOrder} />
            ) : (
